    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          <!-- 내용 넣는 공간 -->
          <form action="${pageContext.request.contextPath}/freeboard/actionUpdateFreeContentForm?free_idx=${freeData.freeVO.free_idx}&pageNum=${pageNum}" role="form" method="post" class="writeForm" autocomplete="off">
              <div class="form-group">
                  <label for="free_title" class="sr-only">제목</label>
                  <input type="text" name="free_title" class="form-control" placeholder="${freeData.freeVO.free_title }" required>
              </div>
              <div class="form-group">
            ...
            <!-- 글 입력 -->
            <textarea name="free_content" id="free_content" rows="20" cols="80" required>${freeData.freeVO.free_content }</textarea>
          <script>
          ...
          <!-- 글 입력 끝 -->
  			<br>
        <a href="${pageContext.request.contextPath }/freeboard/freeBoard?pageNum=${pageNum}"><input type="button" class="btn btn-primary" value="목록으로"></a>
