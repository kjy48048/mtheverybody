	...
	<div class="wrapper">
		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<form
					action="${pageContext.request.contextPath }/admin/actionRegisterItemForm"
					method="post" enctype="multipart/form-data">
					<h2 class="text-uppercase mt-3 font-weight-bold">관리자 물품 등록</h2>
					<div class="col-lg-4">
						<div class="form-group imageUpload">
							...
							<div
								...
								<div
									...
									<img style="max-width:100%;max-height:90%;" src="${pageContext.request.contextPath}/resources/img/noImage.jpg" id="img"><p id="preImg">이미지 사진 등록</p></div>
							</div>
							<div class="filebox">
								<label for="ex_file" class="btn btn-light"
									style="margin-top: 10px;">이미지 업로드</label> <input type="file"
									name="files" multiple="multiple" id="ex_file" hidden>
							</div>
						</div>
					</div>
					<div class="row" style="margin-top: 20px;">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<div class="form-control mt-2">
									${sessionLoginedData.member_nick }
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<input type="hidden" name="item_condition" value="NORMAL">
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label for="brand_idx">판매 브랜드명</label> <select name="brand_idx"
									id="brand_idx" class="form-control mt-2" style="height:32px;" required>
									<option value="">- 편의점 브랜드 선택 -</option>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label for="item_type_idx">관리자 물품 종류 </label> <select
									name="item_type_idx" id="item_type_idx"
									class="form-control mt-2" style="height:32px;" required>
									<option value="">- 관리자 물품 종류 선택 -</option>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label for="item_name">관리자 물품명</label> <input type="text"
									class="form-control mt-2" name="item_name" required>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="form-group">
								<label for="item_originprice">소비자 판매가격</label> <input
									type="number" class="form-control mt-2" name="item_originprice"
									required>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea class="form-control" id="exampleFormControlTextarea1"
									...
									name="item_content" required></textarea>
							</div>
						</div>
						<div class="col-4">
